    ...
    mainPanel(
      tabsetPanel(
        tabPanel("Input", selectInput(inputId="motor", label="Motor", choices = c("Redline","BAG","CIM","MiniCIM"), selected = "Redline"), 
                 ...
                 numericInput(inputId="velEfficiency", label="Velocity efficiency (%)", value=90, min=0, max=100, step=5),
                 numericInput(inputId="torqueEfficiency", label="Torque efficiency (%)", value=90, min=0, max=100, step=5),
                 ...
                 numericInput(inputId="deltaTime", label="Delta time (seconds)", value=0.001, min=0.0001, step=0.001),
